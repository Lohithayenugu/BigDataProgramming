...
class StreamListener(tweepy.StreamListener):
    def on_status(self, status):
        ...
        with open("/home/lohitha/Desktop/BigDataProgramming/COVID19_Data1.json", "a", encoding='utf-8') as f:
            f.write('{"id":"%s","date":"%s","tweetuser":"%s","isretweet":"%s","isquote":"%s","tweettext":"%s","quotedtext":"%s"}\n' % (status.id_str,status.created_at,status.user.screen_name,is_retweet,is_quote,text,quoted_text))
...
if __name__ == "__main__":
    ...
    with open("/home/lohitha/Desktop/BigDataProgramming/COVID19_Data1.json", "w", encoding='utf-8') as f:
        f.write("id,d,usr,\n")
